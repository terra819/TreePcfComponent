...
import { TreePcfComponent, ITreeSelectProps } from "./TreePcfComponent";
...
export abstract class TreePcfComponentBase<TInputs, TOutputs> implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    private treePcfComponentContainer: HTMLDivElement;
    ...
    public async init(
        ...
        console.log("TreePcfComponentBase init");
        ...
        this.treePcfComponentContainer = container;
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        ...
        ReactDOM.render(React.createElement(TreePcfComponent, this.props), this.treePcfComponentContainer);
